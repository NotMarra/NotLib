...
public class GUIPulseAnimation extends GUIAnimation {
    ...
    public GUIPulseAnimation(GUI gui, long durationTicks, long frames) {
        this(gui, durationTicks, frames, DEFAULT_PULSE_COUNT, DEFAULT_MIN_VALUE, DEFAULT_MAX_VALUE);
    }

    public GUIPulseAnimation(GUI gui, long durationTicks, long frames, int pulseCount, float minValue, float maxValue) {
    ...
    public GUIPulseAnimation setPulseCount(int pulseCount) {
        this.pulseCount = pulseCount;
        return this;
    }

    public GUIPulseAnimation setMinValue(float minValue) {
        this.minValue = minValue;
        return this;
    }

    public GUIPulseAnimation setMaxValue(float maxValue) {
        this.maxValue = maxValue;
        return this;
    }

    public GUIPulseAnimation setValues(int pulseCount, float minValue, float maxValue) {
        this.pulseCount = pulseCount;
        this.minValue = minValue;
        this.maxValue = maxValue;
        return this;
